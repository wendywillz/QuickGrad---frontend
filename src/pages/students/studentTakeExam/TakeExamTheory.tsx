    ...
    <div className="examContainer">
      ...
      <div className="main-container">
        <div className="div-for-first-form">
          ...
          <div className="lower-part-of-first-form">
            ...
            <p className="second-p">
              1. There are 2 sections. Answer all questions in section A and any
              5 questions in section B
            </p>
            <p className="second-p">
              2. Time allowed is 2 hours, after which the session ends and your
        ...
        <form action="/" className="second-formB">
          ...
          <textarea name="one">
            Students often face difficulties in accessing their results on time
            and also knowing how they did and what they got right or wrong.
            Universities also face challenges in managing large volumes of data
            because of the number of students and delivering results in a timely
            and efficient manner.
          </textarea>

          <div className="anchor-divB">
            <a href="./take-exam-obj" id="first-anchorB">
            ...
            <button>5</button>
            <button>6</button>
            <a href="./take-exam-theory" id="second-anchorB">
              Next Section &rarr;
            </a>
          </div>

          <button className="submitExam" type="submit">
            Submit exam
          </button>
        </form>
      </div>
