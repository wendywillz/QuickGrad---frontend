...
function FormRowAndSelection(props: Props){
  // const countIncrease = ()=>{return props.count++}
    ...
    return(
        <form
                className="set-exams-page-questions-form"
                action="#"
                method="post"
              >
...
<div className="set-exam-page-add-question-botton-container">
    <form className="set-exam-page-add-question-button" action="#" method="post">
        <button className="set-exams-page-questions-form-multiple-choice-add-question-button" type="submit"> + </button>
    </form>
</div>
...
<div className="set-exams-page-questions-form-multiple-choice-answers-container">
    <label className="set-exams-page-questions-form-multiple-choice-answer-label" htmlFor="aInput">
